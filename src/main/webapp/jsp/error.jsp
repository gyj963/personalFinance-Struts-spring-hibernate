...
<head>
    ...
    <%--<link rel="search" type="application/opensearchdescription+xml" href="http://www.dailymile.com/opensearch.xml" />--%>
    <style type="text/css">
        body { margin: 0; padding: 0; font-family: "helvetica neue", helvetica, arial, sans-serif; font-size: 13px; background: #8dd3d5 repeat-x 0 0; }
        ...
        #content {
            ...
            min-height: 700px;
            background: url("../css/images/shoes_hanging.png") no-repeat 50% 120px;
        }
...
<body>
<div id="error_page">
    <img id="background" src="../css/images/404background.jpg" alt="clouds" />
    <div id="content">
        <h1>It has gone missing.</h1>
            <h2>Sorry, this page isn't here or has moved.</h2>
            <p>Return to <a href="#" onclick="history.go(-1)">last page</a></p>
    </div>
</div>
</body>
</html>